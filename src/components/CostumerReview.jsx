...
const CostumerReview = () => {
  ...
  return (
      ...
      <div className='mt-[200px] max-lg:bg-none bg-red-bg max-xs:bg-white  bg-no-repeat relative  bg-contain min-h-[700px]  h-full w-full py-10'>
              ...
              return (
                <div key={index}>
                  ...
                  <div className='m-2 relative lg:h-[400px] md:h-[300px] max-xs:w-[300px] lg:w-[300px] sm:w-[200px] max-xs:h-[350px] h-[400px] bg-white shadow-md '>
                    <div className="relative xs:h-[100px] max-xs:h-[200px] sm:h-[140px] lg:h-[230px]  w-full max-sm:bg-red-400  ">
